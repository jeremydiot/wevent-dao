...
public final class EventContract extends CommonContract {
	...
	public static final String COL_ADMIN_ID_CONSTRAINT = "REFERENCES "+UserContract.TABLE_NAME+" ("+UserContract.COL_ID_NAME+") ON DELETE CASCADE NOT NULL";
	public static final String COL_TITLE_CONSTRAINT = "NOT NULL";
	public static final String COL_START_DATE_CONSTRAINT = "CHECK ("+COL_START_DATE_NAME+" <= "+COL_END_DATE_NAME+") NOT NULL";
	public static final String COL_END_DATE_CONSTRAINT = "CHECK ("+COL_END_DATE_NAME+" >= "+COL_START_DATE_NAME+") NOT NULL";
